package presentation.todoapp.home
...
import domain.todoapp.RequestState
import domain.todoapp.TaskAction
import domain.todoapp.ToDoTask
...
import presentation.todoapp.task.TaskScreen
...
class ToDoHomeScreen : Screen {
    ...
    override fun Content() {
        ...
        val viewModel = getScreenModel<ToDoHomeViewModel>()
        val activeTasks by viewModel.activeTasks
        val completedTasks by viewModel.completedTasks

        Scaffold(
            topBar = {
                CenterAlignedTopAppBar(title = { Text(text = "TO-DO App") })
            },
